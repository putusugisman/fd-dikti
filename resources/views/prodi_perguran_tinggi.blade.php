@extends('layouts',  ['activeMenu' => 'PRODI_PT', 'activeSubMenu' => 'settings', 'title' => 'Prodi Perguruan Tinggi'])
@section('content')
@section('css')
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Prodi PT</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="alig-center d-flex justify-content-between mb-3">
                    <h4><i class="mdi mdi-format-list-bulleted me-1"></i>Data Prodi Perguruan Tinggi</h4>
                </div>
...
@section('js')
    ...
    <script src="{{ asset('script/prodi_pt.js') }}"></script>
@stop
@endsection