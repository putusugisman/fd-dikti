@extends('layouts',  ['activeMenu' => 'LIST_MAHASISWA', 'activeSubMenu' => 'settings', 'title' => 'List Data Mahasiswa'])
@section('content')
@section('css')
        ...
        <div class="card">
            <div class="card-body">
                <div class="alig-center d-flex justify-content-between mb-3">
                    <h4><i class="mdi mdi-format-list-bulleted me-1"></i>Data List Mahasiswa Tahun {{ $tahun }}</h4>
                    <div class="d-flex justify-content-between">
                        ...
                        {{-- <button class="btn btn-sm btn-danger" id="cancel">Batalkan Perubahan</button> --}}
                    </div>
                </div>
...
@section('js')
    ...
    <script src="{{ asset('script/list_mahasiswa.js') }}"></script>
@stop
@endsection